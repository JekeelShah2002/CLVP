...
export class CustomerDetailComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  /** Helper to clamp values in template */
  ...
  getSegmentClass(segment: string): string {
    ...
    if (s.includes('at-risk'))  return 'bg-rose-400/10 text-rose-500 border-rose-500/30 shadow-[0_0_15px_rgba(244,63,94,0.1)] animate-pulse';
